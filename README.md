...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mir_eval-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10278&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mir_eval-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mir_eval` can be installed with:

```
conda install mir_eval
```

It is possible to list all of the versions of `mir_eval` available on your platform with:
